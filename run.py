...
# dataset settings
parser.add_argument('--rf_finetune',     action='store_true', default=False)
parser.add_argument('--nat_finetune',     action='store_true', default=False)
parser.add_argument('--sample_method',  type=str, default='sentence', choices=['sentence','stepwise'])
parser.add_argument('--stepwise_sampletimes',     type=int, default=10)
